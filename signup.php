            ...
            <div class="container">
                <div class="a">
                  <div class="d-flex justify-content-center mb-5">
                    ...
                    <div class="mb-4">
                      <input type="password" name="confirm_psw" class="form-control inputdiv" placeholder="Confirm Password">
                    </div>
                    <div class="d-flex justify-content-center mx-auto">
                      <button class="btn btn-primary btnbtn create" name="submit" type="submit" >Create Account</button>
